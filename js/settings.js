        ...
        t.exports = function (t, e, n, m, b, y, g) {
          ...
          if (
            (C &&
              ...
              w.next &&
              (u(w, k, !0), r || "function" == typeof w[f] || s(w, f, v)),
            O &&
              T &&
              T.name !== h &&
              ((j = !0),
            ...
            if (
              ((x = { values: O ? _ : L(h), keys: y ? _ : L(d), entries: A }),
              g)
            )
          ...
          (T.prototype.toString = function () {
            ...
            (_.prototype.toString = function () {
              return (
                ...
                (this.user &&
                  j(this.user) + (this.pass && ":" + j(this.pass)) + "@") +
                (this.host && this.host) +
                (this.port && ":" + this.port) +
                (this.path && this.path) +
